...
int main() {
	...
	printf("  sectores_por_fat: %d\n ", bs.sectores_por_fat);
	printf("  sectores_por_head: %d\n ", bs.sectores_por_head);
	printf("  heads_por_cilindro: %d\n ", bs.heads_por_cilindro);
	printf("  heads_por_cilindro: %d\n ", bs.heads_por_cilindro);
	printf("  sectores_ocultos: %d\n ", bs.sectores_ocultos);
	printf("  big_number_sectores: %d\n ", bs.big_number_sectores);
	printf("  big_sectores_por_fat: %d\n ", bs.big_sectores_por_fat);
	printf("  extFlags: %d\n ", bs.extFlags);
	printf("  FSVersion: %d\n ", bs.FSVersion);
	printf("  directorio_inicio: %d\n ", bs.directorio_inicio);
